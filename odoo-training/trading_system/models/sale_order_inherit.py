...
class SaleOrderInherit(models.Model):
    ...
    def product_qty_onchage(self):
            ...
            product_qty=sum(self.order_line.filtered_domain([('product_id.detailed_type','!=','service')]).mapped('product_uom_qty'))
            service_line=self.order_line.filtered_domain([('product_id.detailed_type','=','service')] )    
            service_line.update({
